...
{  
  ...
  //Initialize matrices  
    ...
    //SMC Gainsn and Surface
    Keq[0][0]=3;  Keq[0][1]=-1.45;  Keq[0][2]=-3.63;  Keq[0][3]=0.96;
    Ksw[0][0]=1;
    Cs[0][0]=0.001;  Cs[0][1]=0.0012;  Cs[0][2]=0.0015;  Cs[0][3]=-0.002;
...
*/
    ...
    in3 = read_input3(-0.7, 1, 0);     
    in4 = read_input4(0, 0.5, 0); 
...
Matrix.Multiply((float*)Keq, (float*)x_hat, 1, n, m, (float*)Veq);
Matrix.Multiply((float*)Cs, (float*)x_hat, 1, n, m, (float*)S);

//Chattering Term and Reduction
if (S[0][0]<0)
{
  S[0][0]=-100; 
  S[0][0]=tanh(S[0][0]);
...
Matrix.Multiply((float*)Ksw, (float*)S, 1,1,1, (float*)Vsw);
...
//deadzone - calibrated in SMC

     if (u_k[0][0]> 0.6 && u_k[0][0]<0.5)
       {
         out1=2.0+0.49*u_k[0][0];
       }
     else if (u_k[0][0]<-0.5 && u_k[0][0]>-4.2)
       {
        out1 = -5+2*u_k[0][0]; 
       }
     else
...
*/
  ...
  //write_outx(value, offset, gain, disp) 
   write_out1(out1, 0,  0.25, 1);   // Pin 5  -12V to 12V //con2
